import { Trees, Calendar, Menu, CalendarClock, Users, Dog, Check, Star, MapPin, ShieldCheck, Leaf, Flame, Moon, WifiOff, Book, Coffee } from "lucide-react";

const MistHaven = () => {
  return (
    <div className="min-h-screen bg-slate-950 text-white antialiased font-geist">
      <div 
        ...
        <div className="sm:p-6 lg:p-8 shadow-[0_10px_60px_-15px_rgba(0,0,0,0.6)] bg-white/5 border-white/15 border rounded-3xl pt-4 pr-4 pb-4 pl-4 backdrop-blur-xl">
          ...
          <header className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button className="hidden sm:inline-flex gap-2 hover:bg-white transition font-medium text-slate-900 font-geist bg-white/90 rounded-full pt-2 pr-4 pb-2 pl-4 shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] items-center">
          ...
          <section className="mt-10 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-end">
            ...
            <div className="lg:col-span-5 xl:col-span-4">
              <div className="relative sm:p-6 lg:p-7 ring-1 ring-white/10 bg-slate-900/70 rounded-3xl pt-5 pr-5 pb-5 pl-5 shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] backdrop-blur-xl">
                ...
                <div className="mt-6 flex items-end justify-between">
                  <div className="">
                    <div className="text-2xl text-white font-geist font-medium tracking-tighter">$329<span className="text-base font-medium text-slate-300 font-geist"> / night</span></div>
                    <div className="text-xs text-slate-400/80 font-geist">Taxes and fees not included</div>
                  </div>
                  <button className="inline-flex gap-2 hover:bg-white/90 transition font-medium text-slate-900 font-geist bg-white rounded-full pt-2.5 pr-5 pb-2.5 pl-5 shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] items-center">
                    Reserve
                  </button>
                </div>
              </div>
