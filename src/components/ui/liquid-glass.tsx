  ...
  return (
    ...
    >
      ...
      {showLeftArrow && (
        <button
          onClick={scrollLeft}
          className="absolute left-[-11px] top-1/2 transform -translate-y-1/2 z-40 p-1 rounded-full bg-black/20 hover:bg-black/30 transition-all duration-200"
        >
      ...
      {showRightArrow && (
        <button
          onClick={scrollRight}
          className="absolute right-[-11px] top-1/2 transform -translate-y-1/2 z-40 p-1 rounded-full bg-black/20 hover:bg-black/30 transition-all duration-200"
        >
