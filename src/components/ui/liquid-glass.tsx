  ...
  return (
    ...
    >
      ...
      {showLeftArrow && (
        <button
          onClick={scrollLeft}
          className="absolute left-2 top-1/2 transform -translate-y-1/2 z-30 p-1 rounded-full bg-black/20 hover:bg-black/30 transition-all duration-200 pointer-events-auto"
        >
      ...
      {showRightArrow && (
        <button
          onClick={scrollRight}
          className="absolute right-2 top-1/2 transform -translate-y-1/2 z-30 p-1 rounded-full bg-black/20 hover:bg-black/30 transition-all duration-200 pointer-events-auto"
        >
